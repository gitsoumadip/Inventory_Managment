$(document).ready(function () {
    ...
    $("#modalForm").validate({
        ...
        messages: {
            name: {
                ...
                minlength: "Name should not be less than 3 characters long",
                maxlength: "Name should not be more than 100 characters long",
                remote: "Name is already used",
            },
            code: {
                required: "Code must not be empty",
                minlength: "Code should not be less than 3 characters long",
                maxlength: "Code should not be more than 100 characters long",
                remote: "Code is already used",
            },
        },
    ...
    $("#openModalButton").click(function () {
        ...
        $("#formHead").text("Add Value List Master");
...
const filtering = () => {
    dataTable = $("#indexTable").DataTable({
        oLanguage: {
            sEmptyTable: "No Value List Master Available",
        },
        dom: "Bfrtip",
        buttons: [
            "pageLength",
...
function showEditModal(id) {
    $.get(`${SITE_URL}admin/${MODULE_CONTROLLER}/${id}/edit`, function (res) {
        if (res.code == 1) {
            ...
            $("#id").val(res.data.id);
            $("#formHead").text("Edit Value List Master");

$(document).ready(function () {
    ...
    $("#openModalButton").click(function () {
        ...
        $("#formHead").text("Add Product Option");
        openRightModal();
    });
});
                            ...
                            <ul class="left-flow">
                                ...
                                <li>
                                    <a href="javascript:void(0)" ${
                                        data.product_option_values_count == 0 &&
...
function showEditModal(id) {
    ...
    $.get(`${SITE_URL}admin/${MODULE_CONTROLLER}/${id}/edit`, function (res) {
        if (res.code == 1) {
            ...
            let groupArr = [];
            res.data.group_options.forEach((grOpt) => {
                groupArr.push(grOpt.group_id);
            });
            // categories--->groups 
            $("#categories").val(groupArr);
            $("#categories").change();
